...
#include "Player.h"
#include "Object.h"
#include "Tile_Climb2.h"

Tile_Climb2::Tile_Climb2() :Object(ObjectType::TILE)
{
...
Tile_Climb2::~Tile_Climb2()
{
    tile_img.Destroy();

}

void Tile_Climb2::Init()
{
...
void Tile_Climb2::Update()
{
    ...
    {
        p->landing2 = true;
        p->intersect_sadari22 = true;
    }

    else
    {
        p->Gravity2 = true;
        p->intersect_sadari22 = false;
    }
}

void Tile_Climb2::Render(HDC mdc)
{
